...
export default function Product() {
  ...
  const handleChangePage = React.useCallback((event: unknown, newPage: number) => {
      ...
      const numEmptyRows =
        newPage > 0 ? Math.max(0, (1 + newPage) * DEFAULT_ROWS_PER_PAGE - rows.length) : 0;
  ...
  return (
    <Box sx={{ width: '100%' }}>
        <Button variant='contained' sx={{marginBottom: "12px"}} onClick={()=>{navigate("/create")}}>Create new product</Button>
